...
exports.LanguagePolicyConverter = exports.LanguagePolicy = void 0;
/**
 * Language policy with fallback for each language as most specific to default en-us -> en -> default.
 */
class LanguagePolicy extends Map {
    /**
     ...
     */
    static defaultPolicy(defaultLanguages = []) {
        ...
        for (const locale of LanguagePolicy.locales) {
            ...
            if (locale === '') {
                if (defaultLanguages.length) {
                    defaultLanguages.forEach((u) => fallback.push(u));
                }
                else {
                    fallback.push('');
                }
...
exports.LanguagePolicy = LanguagePolicy;
LanguagePolicy.locales = [
    '',
    'aa',
    'aa-dj',
    'aa-er',
...
exports.LanguagePolicyConverter = LanguagePolicyConverter;
//# sourceMappingURL=languagePolicy.js.map