...
class CrossTrainedRecognizerSet extends adaptiveRecognizer_1.AdaptiveRecognizer {
    ...
    processResults(results) {
        ...
        for (let i = 0; i < this.recognizers.length; i++) {
            ...
            if (!consensusRecognizedId) {
                ...
                if (!intent || intent === 'None') {
                    ...
                    const recognizersWithRealIntents = pickBy_1.default(recognizerResults, (value) => !this.isRedirect(botbuilder_1.getTopScoringIntent(value).intent));
        ...
        const mergedEntities = results.reduce((acc, curr) => merge_1.default(acc, curr.entities), {});
        const sentiment = results.reduce((acc, curr) => merge_1.default(acc, curr.sentiment), {});
        // return none
        const recognizerResult = {
            text,
            intents: { None: { score: 1.0 } },
