...
class TextTemplateConverter {
     ...
     */
    convert(value) {
        return typeof value === 'string' ? new templates_1.TextTemplate(value) : value;
    }
}
exports.TextTemplateConverter = TextTemplateConverter;
//# sourceMappingURL=textTemplateConverter.js.map