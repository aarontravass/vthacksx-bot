...
class LanguageGeneratorConverter {
     ...
     */
    convert(value) {
        return typeof value === 'string' ? new generators_1.ResourceMultiLanguageGenerator(value) : value;
    }
}
exports.LanguageGeneratorConverter = LanguageGeneratorConverter;
//# sourceMappingURL=languageGeneratorConverter.js.map