 ...
 */
export declare class LanguageGeneratorConverter implements Converter<string, ResourceMultiLanguageGenerator> {
    /**
...
//# sourceMappingURL=languageGeneratorConverter.d.ts.map