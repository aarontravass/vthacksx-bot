 ...
 */
class CodeAction extends botbuilder_dialogs_1.Dialog {
    /**
     ...
     */
    onComputeId() {
        return `CodeAction[${botbuilder_1.StringUtils.ellipsis(this.codeHandler.toString(), 50)}]`;
    }
    /**
    ...
    beginDialog(dc, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.codeHandler(dc, options);
        });
    }
}
