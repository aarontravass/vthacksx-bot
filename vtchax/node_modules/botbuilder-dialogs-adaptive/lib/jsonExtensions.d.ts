 ...
 */
export declare function replaceJsonRecursively(state: DialogStateManager, unit: object): any;
/**
 ...
 * @returns Deep data binding result.
 */
export declare function evaluateExpression(state: DialogStateManager, valExpr: ValueExpression): any;
//# sourceMappingURL=jsonExtensions.d.ts.map