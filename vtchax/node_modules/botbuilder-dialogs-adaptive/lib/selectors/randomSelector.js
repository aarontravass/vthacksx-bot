 ...
 */
class RandomSelector extends triggerSelector_1.TriggerSelector {
    /**
    ...
    select(actionContext) {
        ...
        if (candidates.length > 0) {
            const selection = adaptive_expressions_1.Extensions.randomNext(actionContext.state, 0, candidates.length);
...
RandomSelector.$kind = 'Microsoft.RandomSelector';
