 ...
 */
export declare const skillClientKey: unique symbol;
/**
 * The key to get or set skill conversation id factory from turn state.
 */
export declare const skillConversationIdFactoryKey: unique symbol;
/**
 * Extension methods for skills.
 */
export declare class SkillExtensions {
    /**
...
//# sourceMappingURL=skillExtensions.d.ts.map
