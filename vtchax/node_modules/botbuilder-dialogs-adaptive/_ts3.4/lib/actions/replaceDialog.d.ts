 ...
 */
export declare class ReplaceDialog<O extends object = {}> extends BaseInvokeDialog<O> implements ReplaceDialogConfiguration {
    static $kind: string;
    /**
...
//# sourceMappingURL=replaceDialog.d.ts.map
