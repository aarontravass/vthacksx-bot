 ...
 */
export declare class EntityAssignment implements EntityAssignmentConfiguration {
    /**
     * Event name to surface
     */
    event: string;
    ...
    */
    readonly alternatives: EntityAssignment[];
    /**
...
//# sourceMappingURL=entityAssignment.d.ts.map
