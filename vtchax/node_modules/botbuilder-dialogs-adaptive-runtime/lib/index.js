...
function addSkills(services, configuration) {
    ...
    const tenantId = (_a = configuration.type(['runtimeSettings', 'MicrosoftAppTenantIdKey'], z.string())) !== null && _a !== void 0 ? _a : '';
    if (tenantId) {
        ...
        validTokenIssuers.push(`${botframework_connector_1.AuthenticationConstants.ValidTokenIssuerUrlTemplateV1}${tenantId}/`);
        validTokenIssuers.push(`${botframework_connector_1.AuthenticationConstants.ValidTokenIssuerUrlTemplateV2}${tenantId}/v2.0`);
        validTokenIssuers.push(`${botframework_connector_1.AuthenticationConstants.ValidGovernmentTokenIssuerUrlTemplateV1}${tenantId}/`);
        validTokenIssuers.push(`${botframework_connector_1.AuthenticationConstants.ValidGovernmentTokenIssuerUrlTemplateV2}${tenantId}/v2.0`);
    }
    services.addFactory('authenticationConfiguration', () => {
        ...
        if (skills.length) {
            ...
            return new botframework_connector_1.AuthenticationConfiguration(undefined, botframework_connector_1.allowedCallersClaimsValidator(skills.map((skill) => skill.msAppId)), validTokenIssuers);
        }
        else {
            ...
            return new botframework_connector_1.AuthenticationConfiguration(undefined, allowedCallers.length ? botframework_connector_1.allowedCallersClaimsValidator(allowedCallers) : undefined, validTokenIssuers);
        }
    });
...
function addSettingsBotComponents(services, configuration) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const loadBotComponent = (name) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return botbuilder_1.BotComponent.z.parse(instance);
            }
            catch (err) {
