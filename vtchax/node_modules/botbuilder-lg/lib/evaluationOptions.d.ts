 ...
 */
export declare enum LGLineBreakStyle {
    Default = "default",
    Markdown = "markdown"
}
/**
...
export declare class EvaluationOptions {
    private readonly nullKeyReplaceStrRegex;
    private readonly strictModeKey;
    private readonly replaceNullKey;
    private readonly lineBreakKey;
    private readonly cacheScopeKey;
...
//# sourceMappingURL=evaluationOptions.d.ts.map