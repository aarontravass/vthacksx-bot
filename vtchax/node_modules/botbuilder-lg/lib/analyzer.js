...
class Analyzer extends tree_1.AbstractParseTreeVisitor {
     ...
     */
    constructor(templates, opt, analyzerOptions) {
        super();
    ...
    analyzeTemplate(templateName) {
        ...
        if (this._analyzerOptions && this._analyzerOptions.ThrowOnRecursive === true) {
            ...
            if (stackHasName) {
                throw new Error(`${templateErrors_1.TemplateErrors.loopDetected} ${this.evalutationTargetStack
                    .reverse()
    ...
    analyzeExpressionDirectly(exp) {
        ...
        if (exp.type in this.templateMap) {
            ...
            else if ((this._analyzerOptions && this._analyzerOptions.ThrowOnRecursive === true) ||
