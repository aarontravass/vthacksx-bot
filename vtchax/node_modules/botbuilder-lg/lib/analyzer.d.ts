...
import { IfElseBodyContext, KeyValueStructureLineContext, NormalBodyContext, NormalTemplateBodyContext, NormalTemplateStringContext, StructuredTemplateBodyContext, SwitchCaseBodyContext } from './generated/LGTemplateParser';
...
export declare class Analyzer extends AbstractParseTreeVisitor<AnalyzerResult> implements LGTemplateParserVisitor<AnalyzerResult> {
    ...
    private readonly _analyzerOptions;
    /**
