...
class TemplateExtensions {
    ...
    static getPrefixErrorMessage(context) {
        ...
        if (context.parent && context.parent.parent && context.parent.parent.parent) {
            if (context.parent.parent.parent instanceof LGTemplateParser_1.IfConditionRuleContext) {
                ...
                if (context.parent.parent.parent instanceof LGTemplateParser_1.SwitchCaseRuleContext) {
