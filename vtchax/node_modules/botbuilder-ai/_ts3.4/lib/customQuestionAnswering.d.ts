 ...
 */
export declare const CQAClientKey: unique symbol;
/**
 ...
 */
export declare class CustomQuestionAnswering implements QnAMakerClient, QnAMakerTelemetryClient {
    private readonly endpoint;
    private readonly _logPersonalInformation;
    private readonly _telemetryClient;
    private readonly _options;
    private readonly languageServiceUtils;
    /**
...
//# sourceMappingURL=customQuestionAnswering.d.ts.map
