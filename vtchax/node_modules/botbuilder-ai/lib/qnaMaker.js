...
class QnAMaker {
    ...
    getLegacyAnswersRaw(context, options, telemetryProperties, telemetryMetrics) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([
                // Log telemetry
                this.onQnaResults(result === null || result === void 0 ? void 0 : result.answers, context, telemetryProperties, telemetryMetrics),
                this.generateAnswerUtils.emitTraceInfo(context, result === null || result === void 0 ? void 0 : result.answers, queryOptions),
            ]);
            const qnaResponse = {
                activeLearningEnabled: result.activeLearningEnabled,
                answers: result === null || result === void 0 ? void 0 : result.answers,
            };
            return qnaResponse;
        });
    }
