...
exports.ActiveLearningUtils = void 0;
/**
    ...
    static getLowScoreVariation(qnaSearchResults) {
        ...
        if (topAnswerScore > ActiveLearningUtils.MinimumScoreForLowScoreVariation) {
            ...
            for (let i = 1; i < qnaSearchResults.length; i++) {
                if (ActiveLearningUtils.includeForClustering(prevScore, qnaSearchResults[i].score * 100, ActiveLearningUtils.PreviousLowScoreVariationMultiplier) &&
                    this.includeForClustering(topAnswerScore, qnaSearchResults[i].score * 100, ActiveLearningUtils.MaxLowScoreVariationMultiplier)) {
...
ActiveLearningUtils.MinimumScoreForLowScoreVariation = 20;
/** Maximum Score For Low Score Variation. */
ActiveLearningUtils.MaximumScoreForLowScoreVariation = 95.0;
/** Previous Low Score Variation Multiplier. */
ActiveLearningUtils.PreviousLowScoreVariationMultiplier = 0.7;
/** Max Low Score Variation Multiplier. */
ActiveLearningUtils.MaxLowScoreVariationMultiplier = 1.0;
