...
export declare class HttpRequestUtils {
     ...
     */
    executeHttpRequest(requestUrl: string, payloadBody: string, endpoint: QnAMakerEndpoint, timeout?: number): Promise<QnAMakerResults | KnowledgeBaseAnswers | undefined>;
    /**
